...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        # Show the Success vs. Failed counts for the selected site
...
def update_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        # If ALL sites are selected, render scatter plot with all data
        ...
        print(f"Filtered DataFrame for {selected_site}:\n{filtered_df.head()}")
